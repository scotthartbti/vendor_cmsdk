package org.cyanogenmod.internal.policy;
...
public class NetworkTraffic extends TextView {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(CMSettings.System.getUriFor(
                    CMSettings.System.NETWORK_TRAFFIC_STATE),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(CMSettings.System.getUriFor(
                    CMSettings.System.NETWORK_TRAFFIC_AUTOHIDE),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(CMSettings.System.getUriFor(
                    CMSettings.System.NETWORK_TRAFFIC_AUTOHIDE_THRESHOLD),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(CMSettings.System.getUriFor(
                    CMSettings.System.NETWORK_TRAFFIC_COLOR),
                    false, this, UserHandle.USER_ALL);
        }
    ...
    private void updateSettings() {
        ...
        mState = CMSettings.System.getIntForUser(resolver,
                CMSettings.System.NETWORK_TRAFFIC_STATE, 0,
                UserHandle.USER_CURRENT);

        int networkTrafficColor = CMSettings.System.getIntForUser(resolver,
                CMSettings.System.NETWORK_TRAFFIC_COLOR, -2,
                UserHandle.USER_CURRENT);
